...
export const GRUPOS_FILTRO_DATOS: GrupoFiltroDatos[] = [
  { campo: 'edad', titulo: 'Edad', opciones: opcionesComoLista(EDAD_OPCIONES) },
  { campo: 'genero', titulo: 'Género', opciones: opcionesComoLista(GENERO_OPCIONES) },
  { campo: 'carrera', titulo: 'Carrera universitaria', opciones: opcionesComoLista(CARRERA_OPCIONES), buscador: true },
  { campo: 'areaSeleccionada', titulo: 'Área académica', opciones: opcionesComoLista(AREA_OPCIONES) },
  { campo: 'situacionSeleccionada', titulo: 'Situación actual', opciones: opcionesComoLista(SITUACION_OPCIONES) },
  { campo: 'horasEstudio', titulo: 'Horas de estudio al día', opciones: opcionesComoLista(HORAS_ESTUDIO_OPCIONES), umbral: true },
  { campo: 'horasTrabajo', titulo: 'Horas de trabajo al día', opciones: opcionesComoLista(HORAS_TRABAJO_OPCIONES), umbral: true },
  { campo: 'horasOcio', titulo: 'Horas de ocio al día', opciones: opcionesComoLista(HORAS_OCIO_OPCIONES), umbral: true },
  { campo: 'horasSueno', titulo: 'Horas de sueño al día', opciones: opcionesComoLista(HORAS_SUENO_OPCIONES), umbral: true },
  { campo: 'utilizaIa', titulo: '¿Utiliza IA para actividades académicas?', opciones: opcionesComoLista(UTILIZA_IA_OPCIONES) },
  { campo: 'frecuenciaIa', titulo: 'Frecuencia de uso de IA', opciones: opcionesComoLista(FRECUENCIA_IA_OPCIONES) },
  { campo: 'dependencia', titulo: '¿El uso excesivo de IA genera dependencia?', opciones: opcionesComoLista(DEPENDENCIA_OPCIONES) },
  { campo: 'integrarIa', titulo: '¿Las universidades deberían integrar IA oficialmente?', opciones: opcionesComoLista(INTEGRAR_IA_OPCIONES) },
  { campo: 'herramientas', titulo: 'Herramientas de IA utilizadas', opciones: HERRAMIENTAS_LABELS.map((e) => ({ value: e.key, label: e.label })) },
  { campo: 'propositos', titulo: 'Propósitos de uso de IA', opciones: PROPOSITOS_LABELS.map((e) => ({ value: e.key, label: e.label })) },
  { campo: 'ahorroTiempo', titulo: 'La IA ayuda a ahorrar tiempo académico', opciones: opcionesComoLista(LIKERT_OPCIONES) },
  { campo: 'saludEmocional', titulo: 'La carga académica afecta la salud emocional', opciones: opcionesComoLista(LIKERT_OPCIONES) },
  { campo: 'estresIa', titulo: 'La IA reduce el estrés académico', opciones: opcionesComoLista(LIKERT_OPCIONES) },
  { campo: 'productividad', titulo: 'La IA mejora la productividad académica', opciones: opcionesComoLista(LIKERT_OPCIONES) },
  { campo: 'comprensionIa', titulo: 'La IA ayuda a comprender mejor los temas', opciones: opcionesComoLista(COMPRENSION_IA_OPCIONES) },
  { campo: 'agotamiento', titulo: 'Frecuencia de agotamiento académico', opciones: opcionesComoLista(AGOTAMIENTO_OPCIONES) },
  { campo: 'aspectoPositivoSeleccionado', titulo: 'Aspecto más positivo del uso de IA', opciones: opcionesComoLista(ASPECTO_POSITIVO_OPCIONES) },
  { campo: 'aspectoNegativoSeleccionado', titulo: 'Aspecto más negativo del uso de IA', opciones: opcionesComoLista(ASPECTO_NEGATIVO_OPCIONES) },
];
